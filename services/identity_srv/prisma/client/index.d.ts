  ...
  */
  ...
  export interface ClaimDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * })
     * 
     * // Create many Claims and only return the `uuid`
     * const claimWithUuidOnly = await prisma.claim.createManyAndReturn({ 
     *   select: { uuid: true },
     *   data: [
     *     // ... provide data here
     *   ]
  ...
  export interface PersonDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * })
     * 
     * // Create many People and only return the `uuid`
     * const personWithUuidOnly = await prisma.person.createManyAndReturn({ 
     *   select: { uuid: true },
     *   data: [
     *     // ... provide data here
     *   ]
