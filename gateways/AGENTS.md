...
- Общие decorators/guards/services в `src/common` должны оставаться тонким
  gateway-инструментарием. Если код обслуживает один сервисный adapter, держите
  его рядом с этим adapter, а не в `common`.
